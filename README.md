...
La versión 1.1.1 incluye el catálogo preparado desde `Biblioteca_EL_PUEBLITO_portadas_mejoradas.xlsx`, 141 portadas dentro del repositorio y eliminación protegida de libros sin historial.
